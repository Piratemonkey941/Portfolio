...
export default function Home() {
  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      <Head>
        <title>Anthony Rodriguez Portfolio</title>
        ...
        <section className="min-h-screen">
          <nav className="py-10 mb-12 flex justify-between dark:text-white">
            <h1 className="text-xl font-burtons">
              Developed By Anthony Rodriguez
            </h1>
              ...
              <li>
                <a
                  className="bg-gradient-to-r from-cyan-500 to-teal-500 text-white 
                                 px-4 py-2 border-none rounded-md ml-8"
                  href="#"
                >
                  Resume
                </a>
        ...
        <section>
          <div>
             ...
             <p className="text-md py-2 leading-8 text-gray-800 dark:text-gray-200">
                More about me Since the beginning of my journey as a freelance
          ...
          <div className="lg:flex gap-10">
            ...
            <div className="text-center shadow-lg p-10 rounded-xl my-10  dark:bg-gray-200  flex-1">
              ...
              <p className="text-grey-800 py-1">Adobe Illustrator</p>
              <p className="text-grey-800 py-1">Adobe Premier Pro</p>
            ...
            <div className="text-center shadow-lg p-10 rounded-xl my-10 dark:bg-gray-200 flex-1">
              ...
              <p className="text-grey-800 py-1">Website Maintainance</p>
              <p className="text-grey-800 py-1">Webside Counsolting</p>
            </div>
          </div>
        </section>
